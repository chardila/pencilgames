...
- **PWA/offline**: integración `@vite-pwa/astro`, estrategia cache-first para los assets estáticos. Tras la primera visita con internet, el sitio queda disponible sin conexión (útil en carro/avión).
